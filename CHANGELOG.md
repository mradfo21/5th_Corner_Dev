...
- The start menu plays a shipped title theme when nothing is locked. It is a track written as a title theme, never the editor's audition, so the rule that made the menu play only locked tracks still holds.
