...
(function () {
  ...
  const Movement = (function () {
    const RAMP_MS = 1400;            // look acceleration: time held to reach top speed
    const DEADZONE = 0.2;            // ignore tiny stick wiggle near the center
    const TICK_MS = 90;              // visual + drive loop cadence
    const ROT_MIN = 8;               // deg/latent-frame at the start of a look
    const ROT_MAX = 26;              // deg/latent-frame at full look (0..30 allowed)
