...
| **C3** | A payment can land in the wrong wallet | Credit the account id written into the Checkout Session | test: redeem under another cookie credits the payer; webhook + return credit once | open |
